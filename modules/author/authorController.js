var authorModule = require('./authorModal');
var authorValidation = require('./authorValidation');

var userController = {
    getList: function (req, res, next) {
        authorModule.getAllAuthor().then(function (results) {
            return res.render('modules/author/index', {userData: results});
